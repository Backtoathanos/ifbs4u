...
<body>
    <div class="container">
            ...
            <!-- <div class="col-sm-9"> -->
                <!-- <form id="add-products" class="form-group"> -->
                    ...
                    <!-- <table class="table table-responsive table-hover table-striped table-condensed"> -->
                        ...
                        <!-- </tr>
                        <tr>
                            <td>Product's From</td>
                            <td>
                                <select name="vendor_c" class="form-control">
                                    <!-- <option value="1">Local</option> -->
                                    <!-- <?php 
                                        // Fetch Vendors
                                        // $sql_department = "SELECT * FROM `fbs_vendors`";
                                        // $department_data = mysqli_query($con,$sql_department);
                                        // while($row = mysqli_fetch_assoc($department_data) ){
                                        //    $departid = $row['vendor_id'];
                                        //    $depart_name = $row['vendor_name'];
        ...
        <div class="row" id="search-d">
            <h2 align="center">Update or Delete Products</h2>
            <!--search fields start-->
               <div class="row">
